...
import static edu.aku.hassannaqvi.flood2022.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.flood2022.database.CreateTable.DATABASE_COPY;
import static edu.aku.hassannaqvi.flood2022.database.CreateTable.DATABASE_NAME;
...
import edu.aku.hassannaqvi.flood2022.core.AppInfo;
import edu.aku.hassannaqvi.flood2022.core.MainApp;
import edu.aku.hassannaqvi.flood2022.database.DatabaseHelper;
import edu.aku.hassannaqvi.flood2022.databinding.ActivityLoginBinding;
...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.flood2022.ui.SyncActivity.class).putExtra("login", true));
        } else {
